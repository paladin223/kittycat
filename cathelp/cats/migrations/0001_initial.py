    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to=cats.models.Cat.upload_to_folder)),
                ('color', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cats', to='cats.color')),
            ],
            options={
                'verbose_name': 'кот',
